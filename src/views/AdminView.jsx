...
export default function AdminView() {
  ...
  // (newPenalty/newBonus/newTimeOff — переехали в TeamView компоненты)
  ...
  // (Функции настроек зарплаты updateRange/toggleBonus переехали в TeamView → SalaryPanel)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-indigo-50 pb-6">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-4">
        ...
        {/* ВКЛАДКА: Персонал+ (рейтинг и KPI — остальное переехало в TeamView) */}
        {adminTab === 'personnel' && (personnelTab === 'ratings' || personnelTab === 'kpi') && (() => {
          return (
            <div className="space-y-4">

              {/* (Штрафы / Бонусы / Отпуска переехали в TeamView → Сотрудники) */}
              {/* Бонусы */}
              {/* Рейтинг */}
