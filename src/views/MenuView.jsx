...
import { ShoppingBag, FileText, BarChart3, AlertTriangle, Clock, Bell, Settings, Shield, Users, TrendingUp, WifiOff, FileInput } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-amber-100 p-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="space-y-3">
          ...
          {hasAccess('admin') && <button onClick={() => { setAdminImportMode(true); setCurrentView('text-import'); }} className="w-full bg-gradient-to-r from-purple-400 to-pink-500 rounded-xl p-4 shadow flex items-center gap-3 text-white hover:shadow-lg"><div className="bg-white/20 p-3 rounded-lg"><FileInput className="w-6 h-6" /></div><div className="text-left flex-1"><h3 className="font-bold">🔧 [Админ] Импорт отчёта</h3><p className="text-xs text-white/80">Внести смену за любого сотрудника</p></div></button>}
